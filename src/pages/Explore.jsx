  ...
  return (
    <Screen>
      ...
      <div style={{ position: "relative", marginBottom: 14 }}>
        ...
        <input placeholder="Search artists, venues, festivals..." style={{ width: "100%", padding: "12px 16px 12px 40px", background: colors.white, border: `1.5px solid ${colors.border}`, borderRadius: 14, fontFamily: fonts.body, fontSize: 14, color: colors.ink, outline: "none" }} />
      </div>
